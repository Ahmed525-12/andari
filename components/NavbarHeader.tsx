    ...
    <nav className="fixed top-0 left-0 right-0 z-50 px-4 sm:px-6 lg:px-8 pt-4">
      <div className="bg-blue-600/40 backdrop-blur-3xl rounded-2xl border border-blue-500/20 shadow-lg max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          {/* Contact Button */}
          <div className="hidden md:block">
            <a href='https://wa.me/966560656965' target='_blank' className="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors duration-200 flex items-center space-x-2">
              <svg
                className="w-4 h-4"
                fill="currentColor"
                viewBox="0 0 20 20"
      ...
      {isMenuOpen && (
        <div className="md:hidden mt-2">
          ...
          <a
            ...
            <div className="pt-2">
              <a  href='https://wa.me/966560656965' target='_blank' className="w-full bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors duration-200 flex items-center justify-center space-x-2">
                <svg
                  className="w-4 h-4"
                  fill="currentColor"
                  viewBox="0 0 20 20"
